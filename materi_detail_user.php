    ...
    <body>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light navbar-expand-xl py-3">
                    ...
                    <div class="navbar-nav">
                            <a href="dashboard_parent.php" class="nav-item nav-link">Home</a>
                            <a href="#program-section" class="nav-item nav-link active">Programs</a>
                    </nav>
            </div>
        </div>
        <!-- Navbar End -->
        ...
        <div class="container-fluid program py-5">
            <div class="container py-5">
                ...
                <div class="row g-5 justify-content-center" id=program-section>
                    ...
                    <div class="d-inline-block text-center wow fadeIn" data-wow-delay="0.1s">
                        <a href="dashboard_parent.php" class="btn btn-primary px-5 py-3 text-white btn-border-radius">Kembali ke Dashboard</a>
                    </div>
                </div> 
            </div>
        </div>
